...
import io.github.furaibo9714.diskette.ui_base.common.sheets.links.LinksBottomSheet
...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.copyToClipboard
...
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsEvent.OpenDateSelectionSheet
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsEvent.RequestWidgetsUpdate
import io.github.furaibo9714.diskette.ui_movie.databinding.FragmentMovieDetailsBinding
import io.github.furaibo9714.diskette.ui_movie.helpers.MovieDetailsMeta
import io.github.furaibo9714.diskette.ui_movie.views.AddToMoviesButton.State.ADD
import io.github.furaibo9714.diskette.ui_movie.views.AddToMoviesButton.State.IN_HIDDEN
import io.github.furaibo9714.diskette.ui_movie.views.AddToMoviesButton.State.IN_MY_MOVIES
import io.github.furaibo9714.diskette.ui_movie.views.AddToMoviesButton.State.IN_WATCHLIST
...
import io.github.furaibo9714.diskette.ui_navigation.java.NavigationArgs.REQUEST_MANAGE_LISTS
  ...
  private fun openShareSheet(movie: Movie) {
    val intent = Intent().apply {
      val text = "${movie.title}:" +
        ...
        "\n" +
        "https://www.themoviedb.org/movie/${movie.ids.tmdb.id}"
