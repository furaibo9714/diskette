...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.trimWithSuffix
...
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsEvent.OpenPeopleSheet
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsEvent.OpenPersonSheet
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsFragment
import io.github.furaibo9714.diskette.ui_movie.MovieDetailsViewModel
import io.github.furaibo9714.diskette.ui_movie.R
import io.github.furaibo9714.diskette.ui_movie.databinding.FragmentMovieDetailsPeopleBinding
import io.github.furaibo9714.diskette.ui_movie.sections.people.recycler.ActorsAdapter
...
import io.github.furaibo9714.diskette.ui_people.details.PersonDetailsBottomSheet
import io.github.furaibo9714.diskette.ui_people.list.PeopleListBottomSheet
...
class MovieDetailsPeopleFragment : BaseFragment<MovieDetailsPeopleViewModel>(R.layout.fragment_movie_details_people) {
  ...
  private fun openPersonSheet(
    ...
    handleSheetResult()
    val bundle = PersonDetailsBottomSheet.createBundle(person, movie.ids.media, personArgs)
  ...
  private fun openPeopleSheet(event: OpenPeopleSheet) {
    ...
    val title = (requireParentFragment() as MovieDetailsFragment)
      ...
      .toString()
    val bundle = PeopleListBottomSheet.createBundle(movie.ids.media, title, Mode.MOVIES, department)
