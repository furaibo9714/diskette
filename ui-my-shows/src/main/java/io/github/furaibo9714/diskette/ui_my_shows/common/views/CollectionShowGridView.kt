package io.github.furaibo9714.diskette.ui_my_shows.common.views
...
import io.github.furaibo9714.diskette.ui_my_shows.databinding.ViewGridShowBinding
...
class CollectionShowGridView : ShowView<CollectionListItem.ShowItem> {
  ...
  override fun loadImage(item: CollectionListItem.ShowItem) {
  ...
  override fun onImageLoadFail(item: CollectionListItem.ShowItem) {
  ...
  private fun clear() {
    with(binding) {
      ...
      Glide.with(this@CollectionShowGridView).clear(gridShowImage)
    }
  }
}
