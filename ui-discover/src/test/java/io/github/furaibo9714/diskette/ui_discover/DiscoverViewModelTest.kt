...
import io.github.furaibo9714.diskette.ui_discover.cases.DiscoverFiltersCase
import io.github.furaibo9714.diskette.ui_discover.cases.DiscoverShowsCase
...
class DiscoverViewModelTest : BaseMockTest() {
  ...
  fun `Should post error message on error`() =
    runTest {
      ...
      assertThat(messagesResult.last().consume()).isEqualTo(io.github.furaibo9714.diskette.ui_base.R.string.errorCouldNotLoadDiscover)
