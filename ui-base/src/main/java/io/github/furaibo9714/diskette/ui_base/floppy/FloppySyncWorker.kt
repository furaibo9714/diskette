...
import io.github.furaibo9714.diskette.ui_base.events.FloppySyncStart
...
import io.github.furaibo9714.diskette.ui_base.floppy.imports.FloppyImportWatchedRunner
import io.github.furaibo9714.diskette.ui_base.floppy.imports.FloppyImportWatchlistRunner
import io.github.furaibo9714.diskette.ui_base.sync.runners.ShowsSyncRunner
...
class FloppySyncWorker @AssistedInject constructor(
  ...
  private fun createNotificationChannel(): String {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      val id = "Diskette Floppy Sync Service"
      val name = "Diskette Floppy Sync"
