package io.github.furaibo9714.diskette.ui_base.common.views
...
import io.github.furaibo9714.diskette.ui_base.common.behaviour.SearchViewBehaviour
import io.github.furaibo9714.diskette.ui_base.databinding.ViewSearchBinding
...
class SearchView :
  ...
  fun setSyncProgress(
    ...
    with(binding) {
      ...
      if (isProgress) {
        searchViewTraktSyncText.text = text ?: context.getString(R.string.textFloppySyncRunning)
      }
    }
  }
}
