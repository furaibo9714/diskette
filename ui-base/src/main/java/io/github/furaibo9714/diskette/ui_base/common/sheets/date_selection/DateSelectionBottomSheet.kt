package io.github.furaibo9714.diskette.ui_base.common.sheets.date_selection
...
import io.github.furaibo9714.diskette.ui_base.databinding.ViewDateSelectionBinding
...
import io.github.furaibo9714.diskette.ui_model.Tip.DATE_SELECTION_DEFAULTS
...
class DateSelectionBottomSheet : BaseBottomSheetFragment(R.layout.view_date_selection) {
    ...
    val dialog = MaterialDatePicker.Builder
      ...
      .setCalendarConstraints(
        CalendarConstraints
          ...
          .build(),
      ).setTheme(R.style.DisketteDatePicker)
  ...
  private fun openTimeSelectionDialog(
    ...
    val dialog = MaterialTimePicker
      .Builder()
      .setTheme(R.style.DisketteTimePicker)
