...
class StatisticsMoviesLoadRatingsCaseTest : BaseMockTest() {
  ...
  fun `Should load sorted ratings properly`() =
    runTest {
      ...
      val movies = listOf(
        Movie.EMPTY.copy(Ids.EMPTY.copy(media = MediaId.tmdb(1))),
        Movie.EMPTY.copy(Ids.EMPTY.copy(media = MediaId.tmdb(2))),
        Movie.EMPTY.copy(Ids.EMPTY.copy(media = MediaId.tmdb(3))),
        Movie.EMPTY.copy(Ids.EMPTY.copy(media = MediaId.tmdb(4))),
        Movie.EMPTY.copy(Ids.EMPTY.copy(media = MediaId.tmdb(5))),
      )
