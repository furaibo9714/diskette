...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.invisible
...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.setTextFade
...
import io.github.furaibo9714.diskette.ui_episodes.R
import io.github.furaibo9714.diskette.ui_episodes.databinding.ViewEpisodeDetailsBinding
import io.github.furaibo9714.diskette.ui_episodes.details.links.EpisodeLinksBottomSheet
...
class EpisodeDetailsBottomSheet : BaseBottomSheetFragment(R.layout.view_episode_details) {
  ...
  private fun setupView() {
    binding.run {
      val (_, episode, _, isWatched, showTabs) = options
