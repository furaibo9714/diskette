...
import io.github.furaibo9714.diskette.ui_show.sections.ratings.cases.ShowDetailsRatingSpoilersCase
  ...
  fun loadRatings(show: Show) {
    ...
    viewModelScope.launch {
      ...
      try {
        ...
        ratingsState.value = ratingsSpoilersCase.hideSpoilerRatings(show, loadingRatings)
