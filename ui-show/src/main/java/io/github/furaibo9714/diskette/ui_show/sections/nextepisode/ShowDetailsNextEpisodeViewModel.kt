...
import io.github.furaibo9714.diskette.ui_show.sections.nextepisode.cases.ShowDetailsNextEpisodeCase
import io.github.furaibo9714.diskette.ui_show.sections.nextepisode.cases.ShowDetailsTranslationCase
import io.github.furaibo9714.diskette.ui_show.sections.nextepisode.cases.ShowDetailsWatchedCase
  ...
  fun loadNextEpisode(show: Show) {
    ...
    viewModelScope.launch {
      try {
        ...
        val episode = nextEpisodeCase.loadNextEpisode(show.ids.media)
        episode?.let {
