...
import io.github.furaibo9714.diskette.ui_base.common.sheets.ratings.RatingsBottomSheet.Options.Operation.REMOVE
import io.github.furaibo9714.diskette.ui_base.common.sheets.ratings.RatingsBottomSheet.Options.Operation.SAVE
...
import io.github.furaibo9714.diskette.ui_model.Tip.SHOW_DETAILS_GALLERY
...
import io.github.furaibo9714.diskette.ui_show.databinding.FragmentShowDetailsBinding
import io.github.furaibo9714.diskette.ui_show.views.AddToShowsButton
  ...
  private fun openShareSheet(show: Show) {
    val intent = Intent().apply {
      val text = "${show.title}:" +
        ...
        "\n" +
        "https://www.themoviedb.org/tv/${show.ids.tmdb.id}"
