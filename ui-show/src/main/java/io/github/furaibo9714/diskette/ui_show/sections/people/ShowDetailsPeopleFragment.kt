...
import io.github.furaibo9714.diskette.ui_show.ShowDetailsEvent.OpenPeopleSheet
import io.github.furaibo9714.diskette.ui_show.ShowDetailsEvent.OpenPersonSheet
...
import io.github.furaibo9714.diskette.ui_show.databinding.FragmentShowDetailsPeopleBinding
import io.github.furaibo9714.diskette.ui_show.sections.people.recycler.ActorsAdapter
...
class ShowDetailsPeopleFragment : BaseFragment<ShowDetailsPeopleViewModel>(R.layout.fragment_show_details_people) {
  ...
  private fun openPersonSheet(
    ...
    handleSheetResult()
    val bundle = PersonDetailsBottomSheet.createBundle(person, show.ids.media, personArgs)
  ...
  private fun openPeopleSheet(event: OpenPeopleSheet) {
    ...
    val title = (requireParentFragment() as ShowDetailsFragment)
      ...
      .toString()
    val bundle = PeopleListBottomSheet.createBundle(show.ids.media, title, Mode.SHOWS, department)
