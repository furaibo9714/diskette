...
import io.github.furaibo9714.diskette.ui_widgets.BaseWidgetProvider.Companion.EXTRA_MODE_CLICK
    ...
    val remoteView = RemoteViews(context.packageName, getItemLayout()).apply {
      ...
      if (isNewSeason) {
        ...
        val badgeTitle = String
          .format(
            Locale.ENGLISH,
            context.getString(io.github.furaibo9714.diskette.ui_progress.R.string.textSeasonEpisode),
            item.episode.season,
            item.episode.number,
          ).plus(
