...
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.views.MyMovieAllView
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.views.MyMovieCompactView
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.views.MyMovieGridView
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.views.MyMovieHeaderView
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.views.MyMoviesRecentsView
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_MOVIE_ITEM -> BaseAdapter.BaseViewHolder(
      when (listViewMode) {
        ...
        LIST_COMPACT -> MyMovieCompactView(parent.context)
      }.apply {
  ...
  override fun onBindViewHolder(
    ...
    when (holder.itemViewType) {
      ...
      VIEW_TYPE_MOVIE_ITEM -> when (listViewMode) {
        ...
        LIST_COMPACT -> (holder.itemView as MyMovieCompactView).bind(item)
      }
    }
  }
