...
import io.github.furaibo9714.diskette.ui_my_movies.databinding.FragmentMyMoviesBinding
...
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.recycler.MyMoviesAdapter
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.recycler.MyMoviesItem.Type.ALL_MOVIES_ITEM
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.recycler.MyMoviesItem.Type.HEADER
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.recycler.MyMoviesItem.Type.RECENT_MOVIES
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.recycler.MyMoviesLayoutManagerProvider
import io.github.furaibo9714.diskette.ui_my_movies.mymovies.utilities.MyMoviesListItemDecoration
            ...
            when (item?.type) {
              RECENT_MOVIES, HEADER -> {
                when (viewMode) {
                  ...
                  LIST_COMPACT -> if (isTablet) gridSpanSize else LISTS_GRID_SPAN
