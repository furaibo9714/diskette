...
import io.github.furaibo9714.diskette.ui_my_movies.hidden.cases.HiddenLoadMoviesCase
import io.github.furaibo9714.diskette.ui_my_movies.hidden.cases.HiddenSortOrderCase
...
class HiddenViewModel @Inject constructor(
  ...
  init {
    ...
    viewModeState.value = ListViewMode.valueOf(settingsRepository.viewMode.hiddenMoviesViewMode)
  }
