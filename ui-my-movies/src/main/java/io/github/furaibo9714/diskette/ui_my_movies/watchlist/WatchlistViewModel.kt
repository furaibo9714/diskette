...
import io.github.furaibo9714.diskette.ui_my_movies.watchlist.cases.WatchlistFiltersCase
import io.github.furaibo9714.diskette.ui_my_movies.watchlist.cases.WatchlistLoadMoviesCase
import io.github.furaibo9714.diskette.ui_my_movies.watchlist.cases.WatchlistSortOrderCase
...
class WatchlistViewModel @Inject constructor(
  ...
  init {
    ...
    viewModeState.value = ListViewMode.valueOf(settingsRepository.viewMode.watchlistMoviesViewMode)
  }

  fun toggleViewMode() {
    val newMode = viewModeState.value.next()
    settingsRepository.viewMode.watchlistMoviesViewMode = newMode.name
