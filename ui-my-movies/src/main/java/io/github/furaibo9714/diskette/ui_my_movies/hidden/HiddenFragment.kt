...
import io.github.furaibo9714.diskette.ui_my_movies.common.layout.CollectionMovieLayoutManagerProvider
import io.github.furaibo9714.diskette.ui_my_movies.common.layout.CollectionMovieListItemDecoration
import io.github.furaibo9714.diskette.ui_my_movies.common.recycler.CollectionAdapter
import io.github.furaibo9714.diskette.ui_my_movies.common.recycler.CollectionListItem.FiltersItem
import io.github.furaibo9714.diskette.ui_my_movies.common.recycler.CollectionListItem.MovieItem
import io.github.furaibo9714.diskette.ui_my_movies.databinding.FragmentHiddenMoviesBinding
import io.github.furaibo9714.diskette.ui_my_movies.filters.CollectionFiltersOrigin.HIDDEN_MOVIES
import io.github.furaibo9714.diskette.ui_my_movies.filters.genre.CollectionFiltersGenreBottomSheet
import io.github.furaibo9714.diskette.ui_my_movies.filters.genre.CollectionFiltersGenreBottomSheet.Companion.REQUEST_COLLECTION_FILTERS_GENRE
import io.github.furaibo9714.diskette.ui_my_movies.main.FollowedMoviesFragment
import io.github.furaibo9714.diskette.ui_my_movies.main.FollowedMoviesViewModel
          ...
          when (adapter?.getItems()?.get(pos)) {
            is FiltersItem -> {
              when (viewMode) {
                ...
                LIST_COMPACT -> if (isTablet) tabletGridSpanSize else Config.LISTS_GRID_SPAN
