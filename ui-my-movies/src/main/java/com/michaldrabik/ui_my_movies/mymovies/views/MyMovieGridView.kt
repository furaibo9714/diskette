...
import com.michaldrabik.ui_my_movies.databinding.ViewGridMovieBinding
import com.michaldrabik.ui_my_movies.mymovies.recycler.MyMoviesItem

class MyMovieGridView : MovieView<MyMoviesItem> {
  ...
  override fun loadImage(item: MyMoviesItem) {
  ...
  override fun onImageLoadFail(item: MyMoviesItem) {
  ...
  private fun clear() {
    with(binding) {
      ...
      Glide.with(this@MyMovieGridView).clear(gridMovieImage)
    }
  }
}
