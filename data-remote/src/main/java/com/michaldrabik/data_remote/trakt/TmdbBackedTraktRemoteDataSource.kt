...
import com.michaldrabik.data_remote.tmdb.TmdbGenreSlugs
import com.michaldrabik.data_remote.tmdb.TmdbSyntheticIds
import com.michaldrabik.data_remote.tmdb.TmdbToTraktModelConverter
...
internal class TmdbBackedTraktRemoteDataSource(
   ...
   * Showly's `Network` enum encodes broadcaster names as free-text aliases with no shortcut
