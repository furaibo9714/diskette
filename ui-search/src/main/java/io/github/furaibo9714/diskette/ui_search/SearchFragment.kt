...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.colorFromAttr
...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.shake
...
import io.github.furaibo9714.diskette.ui_search.databinding.FragmentSearchBinding
import io.github.furaibo9714.diskette.ui_search.recycler.SearchAdapter
import io.github.furaibo9714.diskette.ui_search.recycler.SearchListItem
import io.github.furaibo9714.diskette.ui_search.recycler.suggestions.SuggestionAdapter
import io.github.furaibo9714.diskette.ui_search.utilities.SearchLayoutManagerProvider
import io.github.furaibo9714.diskette.ui_search.utilities.TextWatcherAdapter
import io.github.furaibo9714.diskette.ui_search.views.RecentSearchView
...
class SearchFragment :
  ...
  private fun openContextMenu(item: SearchListItem) {
    ...
    if (item.isShow) {
      ...
      val bundle = ContextMenuBottomSheet.createBundle(item.movie.ids.media)
