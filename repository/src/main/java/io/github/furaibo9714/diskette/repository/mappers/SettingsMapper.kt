...
import io.github.furaibo9714.diskette.data_local.database.model.Settings as SettingsDb
...
class SettingsMapper @Inject constructor() {
  ...
  fun fromDatabase(settings: SettingsDb) =
    Settings(
      ...
      syncSchedule = enumValueOf(settings.syncSchedule),
      quickSyncEnabled = settings.quickSyncEnabled,
      quickRemoveEnabled = settings.quickRemoveEnabled,
  ...
  fun toDatabase(settings: Settings) =
    SettingsDb(
      ...
      syncSchedule = settings.syncSchedule.name,
      quickSyncEnabled = settings.quickSyncEnabled,
      quickRemoveEnabled = settings.quickRemoveEnabled,
