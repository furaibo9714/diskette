...
data class Settings(
  ...
  @ColumnInfo(name = "sync_schedule", defaultValue = "OFF") val syncSchedule: String,
  @ColumnInfo(name = "quick_sync_enabled", defaultValue = "0") val quickSyncEnabled: Boolean,
  @ColumnInfo(name = "quick_remove_enabled", defaultValue = "0") val quickRemoveEnabled: Boolean,
