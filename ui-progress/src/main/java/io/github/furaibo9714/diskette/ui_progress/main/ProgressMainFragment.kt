...
import io.github.furaibo9714.diskette.ui_base.common.OnShowsMoviesSyncedListener
import io.github.furaibo9714.diskette.ui_base.common.OnTabReselectedListener
...
import io.github.furaibo9714.diskette.ui_base.common.sheets.date_selection.DateSelectionBottomSheet.Companion.REQUEST_DATE_SELECTION
import io.github.furaibo9714.diskette.ui_base.common.sheets.date_selection.DateSelectionBottomSheet.Companion.RESULT_DATE_SELECTION
import io.github.furaibo9714.diskette.ui_base.common.sheets.date_selection.DateSelectionBottomSheet.Result
import io.github.furaibo9714.diskette.ui_base.floppy.format
...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.hideKeyboard
...
import io.github.furaibo9714.diskette.ui_base.utilities.extensions.showKeyboard
...
import io.github.furaibo9714.diskette.ui_navigation.java.NavigationArgs.ACTION_EPISODE_TAB_SELECTED
import io.github.furaibo9714.diskette.ui_navigation.java.NavigationArgs.ARG_SHOW_ID
import io.github.furaibo9714.diskette.ui_navigation.java.NavigationArgs.REQUEST_EPISODE_DETAILS
...
import io.github.furaibo9714.diskette.ui_progress.databinding.FragmentProgressMainBinding
import io.github.furaibo9714.diskette.ui_progress.main.adapters.ProgressMainAdapter
...
class ProgressMainFragment :
  ...
  fun openShowMenu(show: Show) {
    ...
    val bundle = ContextMenuBottomSheet.createBundle(show.ids.media, showPinButtons = true)
